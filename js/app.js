...
var CELULAR_EMPRESA = '5516982095452'
...
cardapio.evetos = {
    ...
    init: () => {
        ...
        cardapio.metodos.cerregarBotaoReserva();  
...
cardapio.metodos = {
    ...
    //obtem a lista de item do cardapio
    ...
    adicionarAoCarrinho:(id) => {
        ...
        if (qntdAtual > 0){
            ...
            if(item.length > 0){
                ...
                //validar se ja exite esse item no carrinho
                let existe = $.grep(MEU_CARRINHHO,(elem,index)=> {return elem.id == id});

                // caso ja exista só altera a quantidade
                if (existe.length > 0){
                    let objIndex = MEU_CARRINHHO.findIndex((obj => obj.id == id));
                    MEU_CARRINHHO[objIndex].qntd = MEU_CARRINHHO[objIndex].qntd + qntdAtual;
                }

                // caso ainda não exista o item no carrinho adiciona ele
                else{
                    item[0].qntd = qntdAtual;
                    MEU_CARRINHHO.push(item[0])
                }
    ...
    removerItemCarrinho: (id) => {
        ...
        MEU_CARRINHHO = $.grep(MEU_CARRINHHO, (e,i) => {return e.id != id});
        cardapio.metodos.carregarCarrinho();
        cardapio.metodos.atualizarBadgeTotal();
    ...
    atualizarCarrinho: (id, qntd) => {
        ...
        let objIndex = MEU_CARRINHHO.findIndex((obj => obj.id == id));
        MEU_CARRINHHO[objIndex].qntd = qntd;
    ...
    // Atulaiza o link do botão do whatsapp
    finalizarPedido: () => {

        if(MEU_CARRINHHO.length > 0 && MEU_CARRINHHO != null) {
